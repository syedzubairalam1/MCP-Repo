Feature: Login and Create Project Flow
  ...
  Scenario: Verify login page UI elements
    Given I am on the login page "https://stage.gatherit.co/users/sign_in"
    Then I should see the logo "Gather"
    And I should see the text "Log into your existing Gather account"
    And I should see the text "We're excited to work with you today"
    ...
    And I should see the text "Need an account?"
    And I should see the button "Forgot your password?"
    And I should see the text "Or log in with Google"

  Scenario: Login with valid credentials
    Given I am on the login page "https://stage.gatherit.co/users/sign_in"
    When I enter "syed@gatherit.co" into the email field
    And I enter "Vista123" into the password field
    And I click on the "Log In" button
    Then I should be redirected to the projects page
    And I should see the section "All Projects"
